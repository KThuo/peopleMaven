...
//Adding data in the Database
    private void jButton_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_addActionPerformed
        String query = "INSERT INTO account VALUES (null,'"+jTextField_empid.getText()+"','"+jTextField_username.getText()+"', '"+jTextField_password.getText()+"', '"+jComboBox_role.getSelectedItem()+"')";
